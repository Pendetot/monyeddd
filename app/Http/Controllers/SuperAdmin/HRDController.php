...
class HRDController extends Controller
{
    ...
    {
        $hrds = HRD::all();
        return view('superadmin.hrd.index', compact('hrds'));
    }

    public function create()
    {
        return view('superadmin.hrd.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return view('superadmin.hrd.account_created', [
            'user' => $hrd,
            'role' => 'hrd',
            'loginLink' => $loginLink,
    ...
    {
        return view('superadmin.hrd.edit', compact('hrd'));
    }
    ...
    public function update(Request $request, HRD $hrd)
    {
        ...
        return redirect()->route('superadmin.hrd.index')->with('success', 'HRD updated successfully!');
    }
    ...
    {
        $hrd->delete();
        return redirect()->route('superadmin.hrd.index')->with('success', 'HRD deleted successfully!');
    }
}